...
const Contact = () => {
    ...
    return (
        <>
            <div className='grid justify-center items-center mt-30'>
                <div className='grid justify-center items-center text-center'>
                    <h1 className=' text-[30px] font-bold'>Contact <span className=' text-blue-700'>Us</span></h1>
                    <p>Any question or remarks? Just write us a message!</p>
                </div>
                <div className=' container bg-white flex p-3 rounded-2xl mt-8 max-[1200px]:grid'>
                    <div className=' bg-[#15435C] text-white grid gap-32 rounded-2xl p-7'>
                        ...
                        <div className='grid gap-3'>
                            ...
                            <div className='flex gap-3 items-center'>
                                <svg className="h-6 w-7 text-white" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">  <path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z" />  <polyline points="22,6 12,13 2,6" /></svg>
                                <p>ieeeobour7@gmail.com</p>
                            </div>
                            <div className='flex gap-3 items-center'>
                                ...
                                <p>Obour University</p>
                            </div>
                        </div>
                        <div className='flex gap-5'>
                            <a href="https://www.linkedin.com/company/ieee-obour-institute" target='_blank'>
                                <img className='w-[30px]' src="/images/linkedin.svg" alt="" />
                            </a>
                            <a href="https://www.instagram.com/ieee_ocs?igsh=cXU4Mnhta3RuNXdw"target='_blank' >
                                <img className='w-[30px]' src="/images/instagram.svg" alt="" />
                            </a>
                            <a href="https://www.facebook.com/share/19VPDmfp3L/?mibextid=wwXIf" target='_blank'>
                    ...
                    <div>
                        <form onSubmit={handleSubmit} className='grid p-4' >
                            <div className='grid gap-11'>
                                ...
                                {/* <div className='flex gap-10 max-[744px]:grid '>
